package com.example.keyboardtest.KeyboardView;
...
import com.example.keyboardtest.KeyboardView.Keyboard.Key;
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    protected int[] mDistances = new int[MAX_NEARBY_KEYS];
